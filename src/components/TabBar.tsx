      ...
      {tabs.map((tab) => {
        ...
        return (
          <div
            ...
            className={`group flex h-full w-[180px] shrink-0 cursor-pointer items-center gap-1.5 rounded-t-md border border-b-0 px-3 text-sm transition ${
              active
          ...
          >
            <Icon
              size={13}
              className={`shrink-0 ${active ? 'text-slate-600' : 'text-slate-400'}`}
            />
